...
from ..layers.spherical_linear_layer import SphericalLinearLayer
from ..layers.pairmix_layer import PairmixLayer
from ..layers.sph_harm_layer_l import SphHarmLayerl
from ..layers.bernstein_layer import BernsteinLayer

class InteractionLayer(layers.Layer):
    def __init__(self, L, F, K, r_cut, cgc, name='interaction', **kwargs):
